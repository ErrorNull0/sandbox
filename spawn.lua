...
--[[ GENERATING DIALOGUE FOR THE VILLAGERS
- villager spawns for the first time
- all villagers have the following dialogue pools:
	family			facts about family: wife, kids, etc.
	village			facts about village: who is baker, farmer, etc
	work			facts about job profession
	hello			various greetings
	hello_trade		various greetings when starting a trade
	hello_walk		various greetings when walking
	hello_busy		various greetings when busy turning or walking back
	bye				various chat closings
	bye_trade_cancel	various chat closings after trading w/out buying
	bye_trade_buy		various chat closings after trading and buying
	region			various remarks about weather
	rain			various remarks when raining
	snow			various remarks when snowing
	random			random words and gestures
	
1) when player right clicks on villager, villager gives a random
dialogue from 'hello' group.
2) then villager will show menu: 
	- ASK ABOUT FAMILY | ASK ABOUT JOB | ASK ABOUT VILLAGE | SMALLTALK | TRADE
	- ASK ABOUT FAMILY: names of family members, number of kids, etc
	- ASK ABOUT VILLAGE: facts about people, shops and region of village
	- ASK ABOUT WORK: facts about work and job title. info about items being
		sold and if any are out of stock, and how soon stock is replenished.
		this button is not shown if villager as nothing in vSell
	- SMALLTALK, used random chats from, 'rain', 'snow', and 'random' groups.
	- TRADE, this button is not shown if villager has nothing in vSell
