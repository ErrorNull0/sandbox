minetest.register_on_newplayer(function(ObjectRef) 
	...
	if villagers.startup_coins then
		
		if log then io.write("\n  Giving statup coins! ") end
		
		local silver_count = math.random(20,30)
		local gold_count = math.random(1,5)
		
		local items = {
			"villagers:coins "..silver_count,
			"villagers:coins_gold "..gold_count
		}
		...
		if log then io.write("silver="..silver_count.." gold="..gold_count.." ") end
