...
local STOCK = {
	apple = 50, bread = 40, string = 60, mushroom_red = 40, mushroom_brown = 40,
...
villagers.ITEMS = {
	...
	tower = {
		default_town_tower = DEFAULTS.forge,
		hochsitz_1 = DEFAULTS.forge,
		hochsitz_2 = DEFAULTS.forge,
		hochsitz_3 = DEFAULTS.forge,
		hochsitz_4 = DEFAULTS.forge
	},
	...
	single = {
		...
		default_town_farm = DEFAULTS.farm_full,
		default_town_house_large_1 = DEFAULTS.farm_tiny,
		default_town_house_large_2 = DEFAULTS.farm_tiny,
		default_town_tower = DEFAULTS.forge,
		tent_big_1 = DEFAULTS.farm_tiny,
		tent_big_2 = DEFAULTS.farm_tiny,
		hochsitz_1 = DEFAULTS.forge,
		hochsitz_2 = DEFAULTS.forge,
		hochsitz_3 = DEFAULTS.forge,
		hochsitz_4 = DEFAULTS.forge,
		chateau_without_garden = DEFAULTS.farm_tiny,
		house_medieval_fancy_1_90 = DEFAULTS.farm_tiny,
		cow_shed_1_270 = DEFAULTS.shed,
		shed_with_forge_v2_1_0 = {
			{split=3, min=6, max=8},
			{"default:sword_steel", STOCK.sword_steel, "villagers:coins", COST.sword_steel},
